        ...
        <Container>
            <Section delay={0.1}>
                ...
                <SimpleGrid columns={[1, 1, 2]} gap={6}>
                    <CardItem id="aws_proxy_server" title="AWS Proxy Server" thumbnail={aws}>
                    ...
                    <CardItem id="mal_monthly" title="Malware Data Scraper" thumbnail={malware}>
            ...
            <Section delay={0.2}>
                <SimpleGrid columns={[1, 1, 2]} gap={6}>
                    <CardItem id="file_sharing_cli_application" title="Secure File-Sharing CLI Application" thumbnail={fsa}>
                        Secure group-based file-sharing CLI application that is secure
                        against a number of different types of security threats
                    </CardItem>
                    <CardItem id="student_loan_site" title="Student Loan Calculation Website" thumbnail={interest}>
                ...
                <SimpleGrid columns={[1, 1, 2]} gap={6}>
                    <CardItem id="cat_cafe_site" title="Cat Cafe Website" thumbnail={catcafe}>
                        Cat Cafe website - currently in development
                    </CardItem>
                    <CardItem id="typing_test_site" title="Typing Test Website" thumbnail={typetest}>
